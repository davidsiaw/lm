...
RSpec.describe Lm::Sum do
  describe '#multiply' do
    it 'does simple multiply' do
      ...
      expect(sop1.multiply(sop2).product_list).to eq [Set.new(['1', '2'])]
    end
    ...
    it 'does distribute multiply' do
      ...
      expect(sop1.multiply(sop2).product_list).to eq [Set.new(['1', '2']), Set.new(['1', '3'])]
    end
    ...
    it 'does fully multiply with more' do
      ...
      expect(sop1.multiply(sop2).product_list).to eq [
        Set.new(['1', '2']), Set.new(['1', '3']), Set.new(['1', '5']),
        Set.new(['4', '2']), Set.new(['4', '3']), Set.new(['4', '5'])
      ]
    end
